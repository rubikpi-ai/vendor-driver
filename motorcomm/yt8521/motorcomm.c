...
#define YT_LINUX_SUBVERSION     25077
#define YT_LINUX_VERSIONID      "2.2.25077"
...
//#define YT8531S_RGMII_DVDDIO_1V8
...
static int yt8531S_config_init(struct phy_device *phydev)
{
    ...
    if(0x31 != val && 0x32 != val)
    {
        ...
        if(0x500 == val)
        {
#if defined (YT8531S_RGMII_DVDDIO_1V8)
...
//#define YT8531_RGMII_DVDDIO_1V8
...
static int yt8531_config_init(struct phy_device *phydev)
{
    ...
    if(0x31 != val && 0x32 != val)
    {
        ...
        if(0x500 == val)
        {
#if defined (YT8531_RGMII_DVDDIO_1V8)
            ret = ytphy_write_ext(phydev, 0xa010, 0xabff);
            if (ret < 0)
                return ret;
